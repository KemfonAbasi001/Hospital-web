  ...
  return (
    <>
      ...
      <section
        ...
        className='w-full py-20 pt-35 lg:py-30 lg:pt-32 flex pl-5 md:pl-8 lg:pl-12 bg-cover bg-center bg-no-repeat'
      >
        <div className="flex flex-col gap-3 lg:gap-4 w-[90%] md:w-[80%] lg:w-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 lg:gap-5 mt-2 lg:mt-3">
            <a href="/emergency" className="flex gap-0 items-center justify-center text-[14px] lg:text-[14px] py-3.5 px-8 lg:px-12 rounded-3xl w-full sm:w-fit leading-5 font-medium text-[#151C28] tracking-[.35px] bg-[#DDA23C]">
              Book a Consultation
            ...
            <a href="/emergency" className="flex gap-0 items-center justify-center text-[14px] lg:text-[18px] py-3 px-8 lg:px-12 rounded-3xl w-full sm:w-fit leading-7 font-medium text-[#FFFFFF] border-[.3px] border-solid border-[white] tracking-[.45px]">
      ...
      <section className='w-full py-16 lg:py-30 flex justify-center items-center'>
        <div className="w-[93%] flex gap-10 lg:gap-15 flex-col">
          ...
          <div className="flex flex-col gap-3 lg:gap-5 w-full">
            <p className="text-[13px] lg:text-[13px] leading-5 font-normal tracking-[4.2px] text-[#DDA23C] uppercase">
              Our Story
            </p>
          ...
          <div className="flex flex-col md:flex-row gap-6 lg:gap-12">
            <div className="w-full relative rounded-2xl overflow-hidden h-64 md:h-80 lg:h-auto">
              ...
              <div className="absolute bottom-5 left-5 lg:bottom-8 lg:left-8">
                <h1 className="text-[20px] md:text-[20px] lg:text-[25px] leading-7 lg:leading-8 font-medium italic text-[#FFFFFF] font-playfair">
            ...
            <div className="w-full relative rounded-2xl overflow-hidden h-64 md:h-80 lg:h-auto">
              ...
              <div className="absolute inset-0 bg-linear-to-b from-transparent to-black/20"></div>
              <div className="absolute bottom-5 left-5 lg:bottom-8 lg:left-8">
                <h1 className="text-[20px] md:text-[20px] lg:text-[24px] leading-7 lg:leading-8 font-medium italic text-[#FFFFFF] font-playfair">
          ...
          <div className="grid w-full grid-cols-1 md:grid-cols-3 gap-5 lg:gap-15">
            <div className="flex items-center justify-center text-center py-8 lg:py-9 bg-[#f2eee980] gap-0 rounded-3xl px-5 flex-col">
              <svg xmlns="http://www.w3.org/2000/svg" className='w-6 h-6 mb-2' viewBox="0 0 24 24" fill="none" stroke="#d19f47" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <section className='w-full pt-0 pb-16 lg:pb-20 flex justify-center'>
        <div className="w-[93%] flex flex-col gap-10 lg:gap-15">
          ...
          <div className="text-center flex flex-col gap-2 lg:gap-3">
            <p className="text-[13px] md:text-[11px] lg:text-[12px] leading-4 tracking-[3.6px] font-medium text-[#DDA23C] uppercase">
              Our Service
            </p>
            <h1 className="text-[32px] md:text-[36px] lg:text-[48px] leading-tight lg:leading-12 font-semibold text-[#151C28] font-playfair">
              Comprehensive Care, Exceptional Results
            </h1>
            <p className="text-[17px] md:text-[16px] lg:text-[18px] leading-6 lg:leading-6.5 font-normal text-[#676F7E]">
       ...
       {/* CTA SECTION */}
            ...
            >
              <div className="flex flex-col justify-center items-center text-center gap-4 lg:gap-5 px-5">
                ...
                <h1 className="text-[33px] md:text-[38px] lg:text-[48px] leading-tight lg:leading-12 font-semibold text-[#FFFFFF] font-playfair">
                ...
                <div className="flex flex-col justify-center sm:flex-row gap-3 lg:gap-5 w-full sm:w-auto">
                  <a href="/emergency" className="bg-[#DDA23C] text-black py-3.5 px-7 lg:py-3.75 lg:px-10 text-[14px] lg:text-[14px] leading-5 font-medium tracking-[.35px] rounded-3xl flex gap-1 items-center justify-center">
                  ...
                  <a href="/emergency" className="flex gap-1 bg-[#ffffff26] border border-solid border-[#F8F6F2] text-[#F8F6F2] py-3.5 px-7 lg:py-3.75 lg:px-10 text-[1px] lg:text-[14px] leading-5 font-medium tracking-[.35px] rounded-3xl items-center justify-center">
